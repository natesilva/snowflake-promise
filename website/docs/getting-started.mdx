...
Code written with previous versions of this library will continue to work thanks to a backwards-compatibility layer. Consider migrating to the new `promisifyConnection` API. See the [Migration Guide](../migration-guide) for details.
