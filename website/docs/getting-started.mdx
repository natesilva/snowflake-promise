...
This library requires the official `snowflake-sdk` as a `peerDependency`. While some package managers (like npm v7+) may install it automatically, you can also explicitly install it:
