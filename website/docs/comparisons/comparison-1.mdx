...
:::info
Please see the [Authentication and MFA](/docs/authentication-and-mfa) section for information about upcoming changes to the way that Snowflake uses usernames/passwords.
:::
